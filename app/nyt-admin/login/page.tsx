...
export default async function AdminLoginPage({ searchParams }: AdminLoginPageProps) {
  ...
  return (
    <main className="min-h-screen bg-navy-950 px-5 py-10 text-white">
      <div className="mx-auto flex min-h-[calc(100vh-5rem)] w-full max-w-md items-center">
        <section
          className="w-full rounded-md border border-white/12 bg-white/[0.06] p-6 shadow-2xl shadow-black/20 sm:p-8"
        ...
        >
          ...
          <h1 id="admin-login-title" className="mt-3 text-3xl font-semibold tracking-normal">
